...
describe('HomePage Component', () => {
  ...
  it('displays the product correctly', async () => {
    ...
    const firstQuantitySelector = within(productContainers[0]).getByTestId('product-quantity-container');
    const secondQuantitySelector = within(productContainers[1]).getByTestId('product-quantity-container');
